...
export function KeyFeatures() {
  return (
    <div className="w-full max-w-2xl mx-auto">
      <h2 className="text-3xl font-semibold text-center text-[#FFD700] mb-6">Key Features</h2>
              ...
              <div className="p-4">
                <Card className="bg-[#001F3F] text-white shadow-lg rounded-lg">
                  <CardContent className="flex flex-col items-center justify-center p-6">
                    ...
                    <h2 className="text-2xl text-[#FFD700] font-semibold mt-4">{feature.title}</h2>
                    <p className="text-lg mt-2 text-gray-300">{feature.description}</p>
                  </CardContent>
                </Card>
              </div>
            </CarouselItem>
